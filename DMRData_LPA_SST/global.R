...
names(DMRDataMeltAgg)<-c("ID","SITE_ID", "latitude", "longitude", "species", "speciesCategory", "equipment", "SST", "SST_StdDev", "BATHY")
## this data has month because SST is aggregated by SITE_ID and Month.
names(DMRDataMeltMonthAgg)<-c("ID","SITE_ID", "latitude", "longitude", "Month", "species", "speciesCategory", "equipment", "SST", "SST_StdDev", "BATHY")
