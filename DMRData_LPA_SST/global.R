...
names(DMRData)<-c("ID", "SITE_ID", "latitude", "longitude", "speciesCategory", "equipment", "LEASE_TYPE", "Status", "StartYr", "EndYr", "BATHY", 
...
names(DMRDataMelt)<-c("SITE_ID", "LSAT8_PPPRRR", "Date", "SST", "latitude", "longitude", "speciesCategory", "BATHY", "Datef", "Month")
